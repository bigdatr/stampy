...
//
// QueryStringHock higher order component
...
// By default this function is called evewry time any query param is change - to limit this use the third argument `onChangeParams`.
//
// The third argument is onChangeParams, which accepts an array of strings of the query parameters you want to listen to.
// For instance, if you pass in ['region', 'dealer'], then onChangeFunction will only be executed when either the region or dealer query param changes
//
...
export default (config = null, onChangeFunction = null, onChangeParams = null) => (ComposedComponent) => {
    ...
    const propsToListenTo = !onChangeParams
        ? [queryPropName]
    ...
    const PreparedComposedComponent = !onChangeFunction
        ...
        : PropChangeHock([queryPropName], (props) => {
            onChangeFunction(propsToListenTo, props);
        })(ComposedComponent);
